"""Компетентность (expertise) из class features."""

from dataclasses import dataclass, field
from typing import Any

from core.catalogs.classes import load_class_full
from core.catalogs.skill_ids import THIEVES_TOOLS_ID
...
def _parse_alternatives(raw: Any) -> list[ExpertiseAlternative]:
