...
from core.progression.xp_levels import xp_for_level
...
def _resolve_stats_and_feat_lists(
    ...
    from core.feats.apply import apply_feats_to_stats
...
def build_new_character(params: CharacterBuildParams) -> Character:
    ...
    from core.inventory.equip_defaults import equip_defaults
