...
**При расхождении:** официальные правила 5e до 2024 > пересказ в `docs/rules/`. Код и YAML отражают реализацию в MUD. Текст в `docs/rules/` — **пересказ механики** (без лора), не дословная копия. Материалы D&D © Wizards of the Coast.
