...
- **Без лора:** в справочнике только механика PHB; описания внешности, культуры и мировоззрения — вне этого справочника.
<!-- /phb:auto:summary -->
...
**В ядре допускаются только официальные расы и подрасы из PHB 2014 (глава 2).** Канон — [`database/races/races.yaml`](../../database/races/races.yaml). Расы вне PHB — только через моды `type: addon`.
...
| UI | [`ui/menus/_selectors.py`](../../ui/menus/_selectors.py) (`select_subrace`), [`ui/menus/display/`](../../ui/menus/display/) |
