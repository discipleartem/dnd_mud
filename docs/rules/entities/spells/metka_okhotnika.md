...
- 211
- 289
quick: 1; divination; 90 футов [конц.] — Пока заклинание активно, вы причиняете цели дополнительный урон
  1к6 каждый раз, когда попадаете п… / Если хиты цели опускаются до 0, пока заклинан
aliases:
- metka_okhotnika
- metka okhotnika
- Метка Охотника
