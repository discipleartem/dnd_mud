...
Канон: [`AGENTS.md`](../../AGENTS.md) · [`dnd-mud-workflow.md`](../rules/dnd-mud-workflow.md) · CI: [`ci.yml`](../../.github/workflows/ci.yml), [`pr-dev-to-main-check.yml`](../../.github/workflows/pr-dev-to-main-check.yml).
...
Full bugbot release-review ([`dnd-mud-review`](dnd-mud-review.md), `Base Branch: main`, ветка `dev`, [checklist-full.md](dnd-mud-review/checklist-full.md)) — только если: (a) в release попали коммиты без task-review; (b) пользователь явно просит; (c) hotfix напрямую в `dev`.
...
Если не пуст — сначала workflow `git-dev-main-sync` (или global git-dev-main-sync).
...
- При падении Action — workflow `git-dev-main-sync`
...
Статус — панель **GitHub Actions** в IDE / на GitHub.
