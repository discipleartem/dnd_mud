...
class TestWelcomeUserUseCase:
    ...
    def test_execute_success_with_ascii_art(self) -> None:
        ...
        self.mock_translation_service.get_translation.side_effect = (
            lambda lang, key, default: {
                ("ru", "welcome_title", "Добро пожаловать в D&D MUD"): "Добро пожаловать в D&D MUD",
                ("ru", "welcome_subtitle", "Текстовая многопользовательская ролевая игра"): "Текстовая MUD игра",
                ("ru", "welcome_description", "Создайте персонажа..."): "Создайте персонажа и исследуйте мир",
                ("ru", "press_enter", "Нажмите Enter для продолжения..."): "Нажмите Enter для продолжения..."
        ...
        self.mock_translation_service.is_language_supported.assert_called_once_with("ru")
    ...
    def test_execute_success_without_ascii_art(self) -> None:
        ...
        self.mock_translation_service.get_translation.side_effect = (
            lambda lang, key, default: {
                ("en", "welcome_title", "Добро пожаловать в D&D MUD"): "Welcome to D&D MUD",
                ("en", "welcome_subtitle", "Текстовая многопользовательская ролевая игра"): "Text MUD game",
                ("en", "welcome_description", "Создайте персонажа..."): "Create a character and explore",
                ("en", "press_enter", "Нажмите Enter для продолжения..."): "Press Enter to continue..."
            }.get((lang, key, default), default)
        )
    ...
    def test_validate_language_unsupported_fallback_to_russian(self) -> None:
        ...
        self.mock_translation_service.is_language_supported.return_value = False
        self.mock_translation_service.get_supported_languages.return_value = ["ru", "en"]
        self.mock_translation_service.get_translation.side_effect = (
    ...
    def test_validate_language_unsupported_fallback_to_first_available(self) -> None:
        """Тест fallback на первый доступный язык."""
        self.mock_translation_service.is_language_supported.return_value = False
        self.mock_translation_service.get_supported_languages.return_value = ["en", "de"]
        self.mock_translation_service.get_translation.side_effect = (
            lambda lang, key, default: default
        )
    ...
    def test_validate_language_no_supported_languages_raises_error(self) -> None:
    ...
    def test_validate_content_missing_title(self) -> None:
        ...
        self.mock_translation_service.get_translation.side_effect = (
            lambda lang, key, default: {
                ...
                ("ru", "welcome_subtitle", "Текстовая многопользовательская ролевая игра"): "Подзаголовок",
                ("ru", "welcome_description", "Создайте персонажа..."): "Описание",
                ("ru", "press_enter", "Нажмите Enter для продолжения..."): "Нажмите Enter"
            }.get((lang, key, default), default)
        )
    ...
    def test_validate_content_missing_subtitle(self) -> None:
        ...
        self.mock_translation_service.get_translation.side_effect = (
            lambda lang, key, default: {
                ("ru", "welcome_title", "Добро пожаловать в D&D MUD"): "Заголовок",
                ("ru", "welcome_subtitle", "Текстовая многопользовательская ролевая игра"): "",
                ("ru", "welcome_description", "Создайте персонажа..."): "Описание",
                ("ru", "press_enter", "Нажмите Enter для продолжения..."): "Нажмите Enter"
            }.get((lang, key, default), default)
        )
    ...
    def test_exception_in_translation_service_returns_fallback(self) -> None:
        ...
        self.mock_translation_service.is_language_supported.side_effect = Exception("Service error")
    ...
    def test_exception_in_ascii_service_continues_without_ascii(self) -> None:
        ...
        self.mock_ascii_art_service.get_dnd_logo.side_effect = Exception("ASCII error")
    ...
    def test_get_supported_languages_success(self) -> None:
        ...
        self.mock_translation_service.get_supported_languages.return_value = ["ru", "en", "de"]
    ...
    def test_get_supported_languages_exception_returns_fallback(self) -> None:
        ...
        self.mock_translation_service.get_supported_languages.side_effect = Exception("Service error")
    ...
    def test_fallback_response_with_ascii_art(self) -> None:
        ...
        assert response.title == "D&D Text MUD"
        assert response.ascii_art is not None  # Должен быть простой ASCII
        assert "____" in response.ascii_art  # Проверка что это ASCII
