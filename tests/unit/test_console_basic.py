"""Тест консоли после рефакторинга."""
...
def test_console_basic_no_colorama():
    ...
    # Удаляем colorama из sys.modules если он там есть
    if 'colorama' in sys.modules:
        del sys.modules['colorama']
    
    # Блокируем импорт colorama внутри модуля console
    with patch('ui.console.Console._init_colorama', return_value=None):
        ...
        with patch('sys.stdout', captured_output):
            ...
            # Проверяем, что clear работает (есть ANSI последовательности)
...
def test_console_with_colorama():
    ...
    with mock_colorama:
        ...
        with patch('sys.stdout', captured_output):
            ...
            # Детальная проверка ANSI кодов требует сложного мока
...
def test_get_int_input():
    ...
    with patch('ui.console.Console._init_colorama', return_value=None):
        ...
        # Тест невалидного ввода с повтором
