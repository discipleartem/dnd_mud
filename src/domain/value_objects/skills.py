...
class SkillsManager:
    ...
    def _load_config(cls) -> None:
        ...
        try:
            ...
            print("Конфигурация навыков не найдена, используем значения по умолчанию")
    ...
    def _load_fallback_config(cls) -> None:
        ...
        # Базовые навыки
        basic_skills = {
            "athletics": SkillConfig(
                "athletics", "Атлетика", "strength", "Прыжки, плавание", ["armor"]
            ),
            "acrobatics": SkillConfig(
                "acrobatics", "Акробатика", "dexterity", "Равновесие", ["armor"]
            ),
            "stealth": SkillConfig(
                "stealth", "Скрытность", "dexterity", "Скрытие", ["armor"]
            ),
            "perception": SkillConfig(
                "perception", "Восприятие", "wisdom", "Заметить скрытых", []
            ),
            "persuasion": SkillConfig(
                "persuasion", "Убеждение", "charisma", "Переговоры", []
            ),
        }
