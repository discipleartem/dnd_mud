...
class JsonCharacterRepository(CharacterRepository):
    ...
    def _load_characters(self) -> None:
        ...
        try:
            ...
            if not isinstance(data, dict):
                print(
                    f"⚠️ Некорректный формат файла данных: ожидается словарь, получено {type(data)}"
                )
            ...
            if not isinstance(characters_data, list):
                print(
                    f"⚠️ Некорректный формат списка персонажей: ожидается список, получено {type(characters_data)}"
                )
                characters_data = []
    ...
    def _save_characters(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Ошибка сохранения персонажей: {e}") from e
