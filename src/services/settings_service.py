...
from src.entities.settings_entity import Setting, GameSettings, SettingType
...
class FileSettingsService(SettingsServiceInterface):
    ...
    def _create_setting_from_data(self, key: str, data: Dict[str, Any]) -> Optional[Setting]:
