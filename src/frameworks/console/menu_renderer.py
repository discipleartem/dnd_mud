...
try:
    ...
    # Заглушки если colorama не доступен
    class Fore:
        RESET = ""
        RED = ""
        GREEN = ""
...
class MenuRenderer:
    ...
    def render_menu(self, context: Dict[str, Any]) -> str:
        ...
        selectable_items = context.get("selectable_items", [])
        ...
        for i, item in enumerate(items):
            ...
            line = self._render_menu_item(item, is_current, is_enabled, i + 1)
            lines.append(line)
    ...
    def _render_menu_item(self, item, is_current: bool, is_enabled: bool, index: int) -> str:
    ...
    def wrap_text(self, text: str, max_width: Optional[int] = None) -> List[str]:
