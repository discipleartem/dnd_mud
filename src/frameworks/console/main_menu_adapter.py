...
from src.dto.menu_dto import MenuStateDTO, MenuControllerResponse
...
class MainMenuAdapter:
    ...
    def _prepare_render_context(self, menu_state: MenuStateDTO) -> Dict[str, Any]:
        ...
        return {
            ...
            "has_navigation": menu_state.selectable_items > 1
        }
    ...
    def _get_selectable_items(self, menu_state: MenuStateDTO):
        ...
        """
        return [
            item for item in menu_state.items 
