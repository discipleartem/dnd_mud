...
class WelcomeController:
    ...
    def show_welcome(
        ...
        try:
            ...
            # Выполнение Use Case
            use_case_response = self._welcome_use_case.execute(
                use_case_request
            )
    ...
    def _transform_request(
        ...
        show_ascii_art = (
            request.show_ascii_art
            if request.show_ascii_art is not None
            else True
        )

        return WelcomeRequest(language=language, show_ascii_art=show_ascii_art)

    def _transform_response(
        self, response: WelcomeResponse
    ) -> WelcomeControllerResponse:
        ...
        return WelcomeControllerResponse(
            ...
            data={
                ...
                "has_ascii_art": response.ascii_art is not None
                and response.ascii_art.strip() != "",
            },
        )
