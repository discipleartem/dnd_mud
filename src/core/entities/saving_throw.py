...
class SavingThrow:
    ...
    def localized_name(self) -> str:
        ...
        return localization.get_saving_throw_name(self.name)
    
    @property
    def localized_description(self) -> str:
        """Возвращает локализованное описание."""
        return localization.get_saving_throw_description(self.name)
    ...
    def calculate_total_bonus(self, character_attributes: dict, proficiency_bonus: int) -> int:
    ...
    def __repr__(self) -> str:
        ...
        return (f"SavingThrow(name='{self.name}', proficiency_bonus={self.proficiency_bonus}, "
