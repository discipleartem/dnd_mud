...
class SavingThrowsManager:
    ...
    def _load_config(cls) -> None:
        ...
        try:
            config_path = Path(__file__).parent.parent.parent.parent / "data" / "yaml" / "attributes" / "saving_throws.yaml"
            ...
            print(f"Конфигурация спасбросков не найдена, используем значения по умолчанию")
    ...
    def _load_fallback_config(cls) -> None:
        ...
        # Базовые спасброски
        basic_saves = {
            'strength': SavingThrowConfig('strength_save', 'Спасбросок Силы', 'strength', 'Сопротивление силе'),
            'dexterity': SavingThrowConfig('dexterity_save', 'Спасбросок Ловкости', 'dexterity', 'Уворот'),
            'constitution': SavingThrowConfig('constitution_save', 'Спасбросок Телосложения', 'constitution', 'Сопротивление ядам'),
            'intelligence': SavingThrowConfig('intelligence_save', 'Спасбросок Интеллекта', 'intelligence', 'Сопротивление ментальным атакам'),
            'wisdom': SavingThrowConfig('wisdom_save', 'Спасбросок Мудрости', 'wisdom', 'Сопротивление иллюзиям'),
            'charisma': SavingThrowConfig('charisma_save', 'Спасбросок Харизмы', 'charisma', 'Сопротивление проклятиям'),
        }
