...
class SaveGameUseCase:
    ...
    def create_new_save(
        ...
        if not self._repository.validate_save_format(game_data):
            raise ValueError("Неверный формат данных сохранения")
    ...
    def get_save_by_id(self, save_id: str) -> SaveGame | None:
    ...
    def get_save_by_slot(self, slot_number: int) -> SaveGame | None:
    ...
    def update_save(
        ...
        updated_save = SaveGame(
            ...
            playtime_minutes=current_game_data["game_state"][
                "playtime_minutes"
            ],
        )
