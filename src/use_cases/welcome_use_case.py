...
class ShowWelcomeScreenUseCase:
    ...
    def execute(self, request: WelcomeControllerRequest) -> WelcomeResponse:
        ...
        return WelcomeResponse(
            ...
            subtitle=welcome_screen.subtitle,
            description=welcome_screen.description,
            ascii_art=welcome_screen.ascii_art,
            language=welcome_screen.language,
