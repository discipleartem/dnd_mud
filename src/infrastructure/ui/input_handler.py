...
class InputHandler:
    ...
    def get_string(self, prompt: str, default: str = "", allow_empty: bool = True) -> str:
    ...
    def get_int(self, prompt: str, min_value: int = None, max_value: int = None, default: int = None) -> int:
