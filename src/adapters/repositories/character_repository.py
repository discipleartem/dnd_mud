...
class CharacterSaveData:
    ...
    def to_character(self) -> Character:
        ...
        character = Character(
            name=self.name,
            level=self.level,
            race=RaceFactory.create_race(RaceFactory.get_race_key_by_name(self.race_name) or self.race_name),
            character_class=CharacterClassFactory.create_class(CharacterClassFactory.get_class_key_by_name(self.class_name) or self.class_name),
        )
