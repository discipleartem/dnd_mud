...
- [ ] git-старт был в начале сессии ([`dnd-mud-git.mdc`](../../rules/dnd-mud-git.mdc) §Git-старт)
...
- [ ] Перейти к skill [`dnd-mud-review`](../dnd-mud-review/SKILL.md) (локальный review **до** push / PR / merge; GitHub PR Bugbot не используется)
